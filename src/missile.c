...
void paint_missiles()
{
	for (int i = 0; i < NUM_MAX_MISSILES; i++) {
		...
		if (missile->exists) {
			switch (missile->type) {
			case MISSILE_TYPE_A:
				paint_missile_type_A(missile->x_coord,
						     missile->y_coord,
						     missile->animation);
				break;
			case MISSILE_TYPE_B:
				paint_missile_type_B(missile->x_coord,
						     missile->y_coord,
						     missile->animation);
			case MISSILE_TYPE_C:
				paint_missile_type_C(missile->x_coord,
						     missile->y_coord,
						     missile->animation);
			default:
				break;
...
void move_missiles()
{
	...
	for (int i = 0; i < NUM_MAX_MISSILES; i++) {
		if (Missiles[i].exists) {
			...
			case MISSILE_TYPE_A:
				speed = MISSILE_TYPE_A_SPEED;
				break;
			case MISSILE_TYPE_B:
				speed = MISSILE_TYPE_B_SPEED;
				break;
			case MISSILE_TYPE_C:
				speed = MISSILE_TYPE_C_SPEED;
				break;
			default:
				break;
			}
